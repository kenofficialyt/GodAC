...
bukkit {
    ...
    website = "https://github.com/kenofficialyt/GodAC"
    apiVersion = "1.13"
    foliaSupported = true

    commands {
        register("antispoof") {
            description = "AntiSpoof command"
            aliases = listOf("as")
        }
        register("combat") {
            description = "Combat check command"
            aliases = listOf("gcombat")
        }
        register("movement") {
            description = "Movement check command"
            aliases = listOf("gmovement")
        }
    }
